...
bool is_compatible_property_descriptor(bool extensible, GC::Ref<PropertyDescriptor>, GC::Ptr<PropertyDescriptor const> current);
bool validate_and_apply_property_descriptor(Object*, PropertyKey const&, bool extensible, GC::Ref<PropertyDescriptor>, GC::Ptr<PropertyDescriptor const> current);
