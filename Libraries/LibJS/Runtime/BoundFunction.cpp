...
ThrowCompletionOr<GC::Ref<BoundFunction>> BoundFunction::create(Realm& realm, FunctionObject& target_function, Value bound_this, GC::RootVector<Value>&& bound_arguments)
{
...
BoundFunction::BoundFunction(Realm& realm, FunctionObject& bound_target_function, Value bound_this, GC::RootVector<Value>&& bound_arguments, Object* prototype)
    : FunctionObject(realm, prototype)
    , m_bound_target_function(&bound_target_function)
    , m_bound_this(bound_this)
    , m_bound_arguments(GC::adopt_root_vector(move(bound_arguments)))
{
}
