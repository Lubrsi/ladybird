...
bool GenericIndexedPropertyStorage::set_array_like_size(GC::Heap& heap, size_t new_size)
{
    ...
    GC::ConservativeHashMap<u32, ValueAndAttributes> new_sparse_elements(heap);
