...
JS_DEFINE_NATIVE_FUNCTION(DatePrototype::to_string)
{
    ...
    return PrimitiveString::create(vm, JS::to_date_string(vm, time));
}
...
ByteString time_zone_string(VM& vm, double time)
{
    ...
    auto default_locale = vm.host_get_default_locale();
    ...
    if (auto name = Unicode::time_zone_display_name(default_locale, tz_name, in_dst, time); name.has_value())
...
ByteString to_date_string(VM& vm, double time)
{
    ...
    return ByteString::formatted("{} {}{}", date_string(time), time_string(time), time_zone_string(vm, time));
}
...
JS_DEFINE_NATIVE_FUNCTION(DatePrototype::to_time_string)
{
    ...
    auto string = ByteString::formatted("{}{}", time_string(local_time(time)), time_zone_string(vm, time));
    return PrimitiveString::create(vm, move(string));
}
