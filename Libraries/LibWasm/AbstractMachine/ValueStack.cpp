...
// Recycled regions keep their committed pages, so resident memory settles at the
// high-water mark of the deepest stack seen on the thread, in exchange for not
// re-faulting pages on every call into wasm. Intentionally leaked at thread exit.
struct RegionPool {
