...
private:
    ...
    virtual void did_update_session_history(u64 page_id, String traversable_navigable_id, i32 current_step, Vector<WebView::SerializedSessionHistoryEntry> entries) override;
    ...
    virtual void did_finish_session_history_operation(u64 page_id, u64 operation_id) override;
