...
public:
    ...
    [[nodiscard]] virtual Result pre_request_check(GC::Ref<Fetch::Infrastructure::Request const>, Policy const&) const { return Result::Allowed; }
    ...
    //    unless otherwise specified.
    [[nodiscard]] virtual Result post_request_check(GC::Ref<Fetch::Infrastructure::Request const>, GC::Ref<Fetch::Infrastructure::Response const>, Policy const&) const { return Result::Allowed; }
    ...
    [[nodiscard]] virtual Result inline_check(GC::Ref<DOM::Element const>, String const&, Policy const&, String const&) const { return Result::Allowed; }
    ...
    [[nodiscard]] virtual Result initialization(Variant<GC::Ref<DOM::Document const>, GC::Ref<HTML::WorkerGlobalScope const>>) const { return Result::Allowed; }
    ...
    [[nodiscard]] virtual Result pre_navigation_check(GC::Ref<Fetch::Infrastructure::Request const>, NavigationType, Policy const&) const { return Result::Allowed; }
    ...
    //    Content Security Policy?. It returns "Allowed" unless otherwise specified.
    [[nodiscard]] virtual Result navigation_response_check(GC::Ref<Fetch::Infrastructure::Request const>, NavigationType, GC::Ref<Fetch::Infrastructure::Response const>, GC::Ref<HTML::Navigable const>, CheckType, Policy const&) const { return Result::Allowed; }
    ...
    [[nodiscard]] virtual Result webrtc_pre_connect_check(Policy const&) const { return Result::Allowed; }

    String const& name() const { return m_name; }
    Vector<String> const& value() const { return m_value; }
