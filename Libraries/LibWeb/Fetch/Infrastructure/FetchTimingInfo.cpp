...
{
    m_final_connection_timing_info = ConnectionTimingInfo::create(vm());
    ...
    m_final_connection_timing_info->set_domain_lookup_start_time(coarsened_domain_lookup_start_time);
    ...
    m_final_connection_timing_info->set_domain_lookup_end_time(coarsened_domain_lookup_end_time);
    ...
    m_final_connection_timing_info->set_connection_start_time(coarsened_connection_start_time);
    ...
    m_final_connection_timing_info->set_connection_end_time(coarsened_connection_end_time);
    ...
    m_final_connection_timing_info->set_secure_connection_start_time(coarsened_secure_connection_start_time);

    m_final_connection_timing_info->set_alpn_negotiated_protocol(alpn_http_version_to_fly_string(final_timings.http_version_alpn_identifier));
