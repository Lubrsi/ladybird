...
static constexpr u16 storage_format_flags = 0;
...
static ErrorOr<void> decode_value(StructuredSerializeDataDecoder& decoder, ErrorType& value)
{
    ...
    auto name = TRY(decode_utf8_text(decoder));
    value = error_name_to_type(name.bytes_as_string_view());
    return {};
}
