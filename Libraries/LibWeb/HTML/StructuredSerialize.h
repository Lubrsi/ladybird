...
WEB_API WebIDL::ExceptionOr<SerializedTransferRecord> structured_serialize_with_transfer(JS::VM&, JS::Value, GC::RootVector<GC::Ref<JS::Object>> const& transfer_list);
