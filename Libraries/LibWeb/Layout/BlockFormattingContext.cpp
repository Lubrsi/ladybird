...
static bool margins_collapse_through(Box const& box, GC::Ref<LayoutState> state)
{
...
static CSSPixels containing_block_height_to_resolve_percentage_in_quirks_mode(Box const& box, GC::Ref<LayoutState const> state)
{
