...
LineBuilder::LineBuilder(InlineFormattingContext& context, GC::Ref<LayoutState> layout_state, LayoutState::UsedValues& containing_block_used_values, CSS::Direction direction, CSS::WritingMode writing_mode)
    : m_context(context)
