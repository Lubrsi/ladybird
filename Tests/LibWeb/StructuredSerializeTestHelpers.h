...
inline Web::HTML::StorageSerializationRecord serializable_storage_record(StringView identifier, u16 payload_version, ReadonlyBytes body = {})
{
    Vector<u8> bytes;
...
inline void frozen_serializable_value(Vector<u8>& bytes, StringView identifier, u16 payload_version, ReadonlyBytes body = {})
{
    bytes.append(to_underlying(ValueTag::SerializableObject));
    append_storage_ascii_utf16(bytes, identifier);
    append_storage_leb128(bytes, payload_version);
