...
ErrorOr<int> ladybird_main(Main::Arguments arguments)
{
    ...
    auto parse_timer = Core::ElapsedTimer::start_new(Core::TimerType::Precise);
    ...
    if (attempt_instantiate || print_compiled || dump_native) {
        ...
        for (auto& name : modules_to_link_in) {
            auto linked_module_parse_timer = Core::ElapsedTimer::start_new(Core::TimerType::Precise);
            ...
            auto instantiation_timer = Core::ElapsedTimer::start_new(Core::TimerType::Precise);
...
#    endif
        ...
        if (!exported_function_to_execute.is_empty()) {
            ...
            auto execution_timer = Core::ElapsedTimer::start_new(Core::TimerType::Precise);
