...
ErrorOr<int> ladybird_main(Main::Arguments arguments)
{
    ...
    parser.add_option(Core::ArgsParser::Option {
        ...
        .accept_value = [&](StringView str) {
            ...
            auto reentry_this = GC::make_root(JS::Object::create(realm, realm.intrinsics().object_prototype()));
            ...
            auto host_function = Wasm::HostFunction {
                [&vm, &function, reentry_this, formal_params, returns, name](Wasm::Configuration&, Span<Wasm::Value> args) mutable -> Wasm::Result {
