...
static u64 s_next_dns_request_id = 1;
...
private:
    ...
    virtual void on_request_finished(u64, Requests::RequestTimingInfo, Optional<Requests::NetworkError> network_error) override
    {
...
private:
        ...
        , m_resolved_host_result(move(resolved_host_result))
    {
        ...
        m_request_headers->set({ "Accept"sv, "application/dns-message"sv });
    }
