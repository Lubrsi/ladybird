...
private:
    ...
    virtual void execute_session_history_prep(u64 page_id, u64 operation_id) override;
    virtual void traversal_canceled(u64 page_id, u64 cancel_callback_id, WebView::TraversalUnloadingCheckResult reason) override;
