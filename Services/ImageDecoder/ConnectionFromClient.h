...
private:
    ...
    virtual Messages::ImageDecoderServer::DecodeImageResponse start_decoding_image(Core::AnonymousBuffer, Optional<Gfx::IntSize> ideal_size, Optional<ByteString> mime_type) override;
