...
set(LADYBIRD_PRESET "" CACHE STRING "Name of the CMake preset in use; populated automatically by presets")
if (NOT LADYBIRD_PRESET OR LADYBIRD_PRESET STREQUAL "Distribution")
    set(LADYBIRD_APP_ID "org.ladybird.Ladybird")
else()
    string(TOLOWER "${LADYBIRD_PRESET}" _ladybird_preset_lower)
    set(LADYBIRD_APP_ID "org.ladybird.Ladybird.${_ladybird_preset_lower}")
    unset(_ladybird_preset_lower)
endif()
