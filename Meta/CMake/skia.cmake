...
#    set(SKIA_SKCMS_TARGET unofficial::skia::modules::skcms)
    ...
    elseif(WIN32)
        ...
        set_property(TARGET unofficial::skia::modules::skcms APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS "SKCMS_API=__declspec(dllimport)")
    endif()
else()
...
#add_library(skia::modules::skcms ALIAS ${SKIA_SKCMS_TARGET})
