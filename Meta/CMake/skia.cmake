...
if(unofficial-skia_FOUND)
    ...
    set(SKIA_PATHOPS_TARGET unofficial::skia::modules::pathops)
    ...
    file(READ ${LADYBIRD_SOURCE_DIR}/Meta/CMake/vcpkg/overlay-ports/skia/vcpkg.json VCPKG_DOT_JSON)
    string(JSON SKIA_REQUIRED_VERSION GET ${VCPKG_DOT_JSON} version)
    ...
    set(SKIA_PATHOPS_TARGET PkgConfig::skia)
endif()
swizzle_target_properties_for_swift(${SKIA_TARGET})
add_library(skia ALIAS ${SKIA_TARGET})
add_library(skia::modules::pathops ALIAS ${SKIA_PATHOPS_TARGET})
